---
name: muddaser-video-editing-skills
description: Edit English or Urdu talking-head videos with Muddaser's hook, evidence, motion and selective-highlight style; study reference videos and maintain a reusable editing library. Use for new edits, revisions, reference analysis or setup of this workflow.
---
...
| Request | Read next | Result |
|---|---|---|
| New video | [creative direction](references/creative-direction.md), then [workflow](references/workflow.md) | Verified MP4 and editable project |
| Revision | Existing project/state, relevant sections of those two files | New version; preserve previous output |
| New samples | [reference study](references/reference-study.md) | Timestamped analysis and additive library update |
